# -*- coding: utf-8 -*-
"""
Created on Fri Apr 14 17:11:40 2017
...
class VariationalGaussianMixture():
    ...
    def __init__(self, n_components=1,init="GMM",n_iter_max=100,alpha_0=1.0,\
                 beta_0=1.0,nu_0=1.5,tol=1e-4,patience=0):
...
#        self._sampling_Normal_Wishart()
        ...
        for i in range(self.n_components):
            ...
            if self.log_prior_prob[i] > -3:
                ...
                ell = utils.ellipses(self.cov_estimated[i],self.means_estimated[i])
                ...
                ax.plot(self.means_estimated[i][0],self.means_estimated[i][1],'kx')
                ax.add_artist(ell)
...
#        print()
    ...
    for j in np.arange(1,11):
        print(j)
        print(">>predicting")
        VBGMM = VariationalGaussianMixture(j,init,alpha_0=1.0/j,beta_0=1.0,nu_0=10,patience=30)
